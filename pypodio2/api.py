...
def OAuthTokenClient(app_id, app_secret, auth_code, redirect_uri, user_agent=None,
                     domain="https://api.podio.com"):
    auth = transport.OAuthTokenAuthorization(app_id, app_secret, auth_code, redirect_uri, domain)
